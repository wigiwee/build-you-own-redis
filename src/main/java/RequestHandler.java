            ...
            while ((content = reader.readLine()) != null) {
                ...
                if (content.startsWith("*")) {
                    ...
                    if (args[0].equalsIgnoreCase("ping")) {
                        ...
                        writer.flush();
                        // byte[] tempFile =
                        // HexFormat.of().parseHex("524544495330303131fa0972656469732d76657205372e322e30fa0a72656469732d62697473c040fa056374696d65c26d08bc65fa08757365642d6d656dc2b0c41000fa08616f662d62617365c000fff06e3bfec0ff5aa2");
                        // StringBuilder output = new StringBuilder();
                        ...
                        // writer.flush();
                        String file = "524544495330303131fa0972656469732d76657205372e322e30fa0a72656469732d62697473c040fa056374696d65c26d08bc65fa08757365642d6d656dc2b0c41000fa08616f662d62617365c000fff06e3bfec0ff5aa2";
                        writer.write("$" + file.length()/2 + Config.CRLF + file);
                        writer.flush();
                    } else {
